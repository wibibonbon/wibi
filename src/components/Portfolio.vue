  ...
  <div class="section">
    <div class="container">
      ...
      <div class="carousel-inner">
        <div :class="[{active:isActive},'grid-item item']"
...
export default {
      ...
      this.displayEntries.unshift(this.displayEntries[this.displayEntries.length-1])
...
@keyframes move {
   ...
   100% { transform: translateX(calc((((-100% / 3) + 25px) * 2))); }
}
